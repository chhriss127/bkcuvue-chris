								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.pertanyaan')}">
											...
											<!-- title -->
											<h5 :class="{ 'text-danger' : errors.has('form.pertanyaan')}">
												<i class="icon-cross2" v-if="errors.has('form.pertanyaan')"></i>
												Pertanyaan: <wajib-badge></wajib-badge></h5>

											<!-- text -->
											<input type="text" name="pertanyaan" class="form-control" placeholder="Silahkan pertanyaan" v-validate="'required|min:5'" data-vv-as="nama" v-model="form.pertanyaan">
											

											<!-- error message -->
											<small class="text-muted text-danger" v-if="errors.has('form.pertanyaan')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.pertanyaan') }}
											</small>
									...
									<!-- <div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.comment')}"> -->
											...
											<!-- text -->
											<!-- <input type="text" name="comment" class="form-control" placeholder="Silahkan masukkan komentar anda" v-validate="'required|min:5'" data-vv-as="comment" v-model="form.comment"> -->
