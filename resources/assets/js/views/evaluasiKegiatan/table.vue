				...
				<div class="col-lg-4 col-md-6">
					<div class="card cursor-pointer" @click.prevent="ubahData(props.item.id)">						
						<div class="card-header bg-light header-elements-inline">
							<h6 class="card-title"><check-value :value="props.item.nama"></check-value>
								</h6>
						</div>
						<div class="card-body">
							<template>
								<img :src="'/images/evaluasiKegiatan/' + props.item.gambar + '.jpg'" class="img-fluid wmin-sm" v-if="props.item.gambar">
							</template>
