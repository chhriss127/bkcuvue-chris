<template>
  <div class="row">
	...
	<!-- Evaluasi -->
    <div class="col-lg-2 col-md-3 col-sm-6 col-6 cursor-pointer" v-if="currentUser.can && currentUser.can['index_artikel']" @click.prevent="goTo(evaluasiWidgetRoute)">
      <count-widget :title="'Evaluasi'" :color="'bg-info-400'" :icon="'icon-newspaper'"></count-widget>
    </div>
...
<script type="text/javascript">
  ...
  import countWidget from '../../components/countWidget';
	...
	export default{
		...
		methods:{
			countWidgetRoute(){
				this.evaluasiWidgetRoute = { name: 'evaluasiWidget', params:{cu: this.currentUser.id_cu} };
