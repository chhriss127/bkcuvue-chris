...
const routes = [
	...
	{ path: '/evaluasiWidget',
	name: 'evaluasiWidget', 
	components: { default: evaluasiWidget,'header': header, 'footer': footer },
	meta: { requiresAuth: true }},
	...
	// baruLagi
	{
		path: '/baruLagi',
		name: 'baruLagi',
		components: { default: baruLagi, 'header': header, 'footer': footer },
		meta: { requiresAuth: true }
	},
	{
			path: '/baruLagi/create',
			name: 'baruLagiCreate',
			components: { default: baruLagi_form, 'header': header, 'footer': footer },
			meta: { requiresAuth: true }
	},
	{
			path: '/baruLagi/edit/:id',
			name: 'baruLagiEdit',
			components: { default: baruLagi_form, 'header': header, 'footer': footer },
			meta: { requiresAuth: true, mode: 'edit' }
	},
