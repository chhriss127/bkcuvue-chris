...
Route::group(['middleware' => 'throttle:60,1'], function () {
    ...
    // Route::group(['prefix'=>'v1'],function(){
        ...
        Route::delete('/sertifikatKegiatan/{id}', 'SertifikatController@destroy');
         ...
         // baru lagi
         Route::get('/baruLagi', 'BaruLagiController@index');
         Route::get('/baruLagi/create', 'BaruLagiController@create');
         Route::post('/baruLagi/store', 'BaruLagiController@store');
         Route::get('/baruLagi/edit/{id}', 'BaruLagiController@edit');
         Route::post('/baruLagi/update/{id}', 'BaruLagiController@update');
         Route::delete('/baruLagi/{id}', 'BaruLagiController@destroy');
