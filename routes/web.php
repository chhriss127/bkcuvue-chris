...
//-----------------------------------------------------------------------------------------------------------------------
		...
		Route::get('/saranBaru',array( 'as' => 'saranBaru.form','uses' => 'SaranBaruController@index'));
		Route::get('/saranBaru',array( 'as' => 'saranBaru','uses' => 'SaranBaruController@saranBaru'));
		Route::post('/saranBaru',array( 'as' => 'saranBaru','uses' => 'SaranBaruController@store'));		
