...
//-----------------------------------------------------------------------------------------------------------------------
    ...
    // {
    //     $title = 'Saran';
    //     $subtitle = 'Masukan dari anda sangat membantu kami';
	// 	$saran_baru = DB::select('select*from saran_baru');
		
    //     return view('halamanBaru', compact('title','subtitle'), ['saran_baru'=> $saran_baru]);
    // }
	...
	// 	return view('tambahSaran',compact('title','subtitle'));
	// }
	// public function tambahData()
	// {
	// 	DB::table('saran_baru')->insert([
	// 				'Nama'=>Request('Nama'),
	// 				'Saran'=>Request('Saran')
	// 			]);
	// 	return Redirect('halamanBaru');
	// }
